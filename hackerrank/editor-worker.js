!function(e) {
    ...
    "5QBA": function(e, t, n) {
        "use strict";
        n.r(t);
        var r, i, o = n("MNsG"), s = (r = Object.setPrototypeOf || {
            __proto__: []
        ...
        var c = ""
          ...
          , d = function() {
            function e(e, t, n, r, i) {
                "object" == typeof e ? (this.scheme = e.scheme || c,
                this.authority = e.authority || c,
                this.path = e.path || c,
                this.query = e.query || c,
                this.fragment = e.fragment || c) : (this.scheme = e || c,
                this.authority = t || c,
            ...
            e.prototype.with = function(e) {
                ...
                var t = e.scheme
                  ...
                  , i = e.query
                  , o = e.fragment;
                return void 0 === t ? t = this.scheme : null === t && (t = c),
                ...
                t === this.scheme && n === this.authority && r === this.path && i === this.query && o === this.fragment ? this : new p(t,n,r,i,o)
            }
            ,
            e.parse = function(e) {
                var t = f.exec(e);
            ...
            e.file = function(e) {
                var t = c;
                if (o.c && (e = e.replace(/\\/g, h)),
                e[0] === h && e[1] === h) {
                    var n = e.indexOf(h, 2);
                    -1 === n ? (t = e.substring(2),
                    e = h) : (t = e.substring(2, n),
                    e = e.substring(n) || h)
                }
          ...
          , p = function(e) {
            ...
            Object.defineProperty(t.prototype, "fsPath", {
                get: function() {
                    return this._fsPath || (this._fsPath = y(this)),
                    this._fsPath
                },
                enumerable: !0,
                configurable: !0
            ...
            t.prototype.toString = function(e) {
                return void 0 === e && (e = !1),
                e ? b(this, !0) : (this._formatted || (this._formatted = b(this, !1)),
                this._formatted)
            }
            ,
        ...
        function g(e, t) {
            for (var n = void 0, r = -1, i = 0; i < e.length; i++) {
                ...
                if (o >= 97 && o <= 122 || o >= 65 && o <= 90 || o >= 48 && o <= 57 || 45 === o || 46 === o || 95 === o || 126 === o || t && 47 === o)
                    ...
                    var s = _[o];
                    void 0 !== s ? (-1 !== r && (n += encodeURIComponent(e.substring(r, i)),
                    r = -1),
                    n += s) : -1 === r && (r = i)
                }
            }
        ...
        function b(e, t) {
            ...
            o) {
                ...
                if (-1 !== l) {
                    var c = o.substr(0, l);
                    o = o.substr(l + 1),
                    -1 === (l = c.indexOf(":")) ? r += n(c, !1) : (r += n(c.substr(0, l), !1),
                    r += ":",
                    r += n(c.substr(l + 1), !1)),
                    r += "@"
                }
                -1 === (l = (o = o.toLowerCase()).indexOf(":")) ? r += n(o, !1) : (r += n(o.substr(0, l), !1),
                r += o.substr(l))
            }
            if (s) {
                if (s.length >= 3 && 47 === s.charCodeAt(0) && 58 === s.charCodeAt(2))
                    (f = s.charCodeAt(1)) >= 65 && f <= 90 && (s = "/" + String.fromCharCode(f + 32) + ":" + s.substr(3));
        ...
        var C = n("VMIq")
          ...
          , L = function() {
            ...
            e.plusRange = function(t, n) {
                ...
                i = t.startColumn),
                n.endLineNumber > t.endLineNumber ? (o = n.endLineNumber,
                s = n.endColumn) : n.endLineNumber === t.endLineNumber ? (o = n.endLineNumber,
                s = Math.max(n.endColumn, t.endColumn)) : (o = t.endLineNumber,
                s = t.endColumn),
                new e(r,i,o,s)
            }
            ,
            ...
            e.intersectRanges = function(t, n) {
                var r = t.startLineNumber
                  ...
                  , c = n.endColumn;
                return r < u ? (r = u,
                i = a) : r === u && (i = Math.max(i, a)),
                o > l ? (o = l,
                s = c) : o === l && (s = Math.min(s, c)),
        ...
        function A(e, t, n) {
            return new x(E(e),E(t)).ComputeDiff(n)
        }
        var w = function() {
            function e() {}
          ...
          , M = function() {
            ...
            return e.prototype.MarkNextChange = function() {
                (this.m_originalCount > 0 || this.m_modifiedCount > 0) && this.m_changes.push(new N(this.m_originalStart,this.m_originalCount,this.m_modifiedStart,this.m_modifiedCount)),
                this.m_originalCount = 0,
                this.m_modifiedCount = 0,
                this.m_originalStart = Number.MAX_VALUE,
                this.m_modifiedStart = Number.MAX_VALUE
          ...
          , x = function() {
            ...
            e.prototype.ComputeDiffRecursive = function(e, t, n, r, i) {
                ...
                if (e > t || n > r) {
                    var o = void 0;
                    return n <= r ? (w.Assert(e === t + 1, "originalStart should only be one more than originalEnd"),
                    o = [new N(e,0,n,r - n + 1)]) : e <= t ? (w.Assert(n === r + 1, "modifiedStart should only be one more than modifiedEnd"),
                    o = [new N(e,t - e + 1,n,0)]) : (w.Assert(e === t + 1, "originalStart should only be one more than originalEnd"),
                    w.Assert(n === r + 1, "modifiedStart should only be one more than modifiedEnd"),
                    o = []),
                    o
                }
                var s = [0]
                ...
                if (!i[0]) {
                    var h = this.ComputeDiffRecursive(e, l, n, c, i)
                      , f = [];
                    return f = i[0] ? [new N(l + 1,t - (l + 1) + 1,c + 1,r - (c + 1) + 1)] : this.ComputeDiffRecursive(l + 1, t, c + 1, r, i),
            ...
            e.prototype.WALKTRACE = function(e, t, n, r, i, o, s, u, a, l, c, h, f, d, m, p, _, g) {
                var v, y, b = null, C = new M, S = t, L = n, E = f[0] - p[0] - r, A = Number.MIN_VALUE, w = this.m_forwardHistory.length - 1;
                do {
                    (y = E + e) === S || y < L && a[y - 1] < a[y + 1] ? (d = (c = a[y + 1]) - E - r,
                    c < A && C.MarkNextChange(),
                    A = c,
                    C.AddModifiedElement(c + 1, d),
                    E = y + 1 - e) : (d = (c = a[y - 1] + 1) - E - r,
                    c < A && C.MarkNextChange(),
                    A = c - 1,
                    C.AddOriginalElement(c, d + 1),
                    E = y - 1 - e),
                    w >= 0 && (e = (a = this.m_forwardHistory[w])[0],
                    S = 1,
                    L = a.length - 1)
                } while (--w >= -1);if (v = C.getReverseChanges(),
                g[0]) {
                    var P = f[0] + 1
                      , x = p[0] + 1;
                    if (null !== v && v.length > 0) {
                        var O = v[v.length - 1];
                        P = Math.max(P, O.getOriginalEnd()),
                        x = Math.max(x, O.getModifiedEnd())
                    }
                    b = [new N(P,h - P + 1,x,m - x + 1)]
                } else {
                    C = new M,
                    S = o,
                    L = s,
                    E = f[0] - p[0] - u,
                    A = Number.MAX_VALUE,
                    w = _ ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
                    do {
                        (y = E + i) === S || y < L && l[y - 1] >= l[y + 1] ? (d = (c = l[y + 1] - 1) - E - u,
                        c > A && C.MarkNextChange(),
                        A = c + 1,
                        C.AddOriginalElement(c + 1, d + 1),
                        E = y + 1 - i) : (d = (c = l[y - 1]) - E - u,
                        c > A && C.MarkNextChange(),
                        A = c,
                        C.AddModifiedElement(c + 1, d + 1),
                        E = y - 1 - i),
                        w >= 0 && (i = (l = this.m_reverseHistory[w])[0],
                        S = 1,
                        L = l.length - 1)
            ...
            e.prototype.ComputeRecursionPoint = function(e, t, n, r, i, o, s) {
                ...
                this.m_forwardHistory = [],
                this.m_reverseHistory = [];
                var m, p, _ = t - e + (r - n), g = _ + 1, v = new Array(g), y = new Array(g), b = r - n, C = t - e, S = e - n, L = t - r, E = (C - b) % 2 == 0;
                for (v[b] = e,
                y[C] = t,
                s[0] = !1,
                l = 1; l <= _ / 2 + 1; l++) {
                    var A = 0
                      , w = 0;
                    for (c = this.ClipDiagonalBound(b - l, l, b, g),
                    h = this.ClipDiagonalBound(b + l, l, b, g),
                    m = c; m <= h; m += 2) {
                        for (a = (u = m === c || m < h && v[m - 1] < v[m + 1] ? v[m + 1] : v[m - 1] + 1) - (m - b) - S,
                        p = u; u < t && a < r && this.ElementsAreEqual(u + 1, a + 1); )
                            u++,
                            a++;
                        if (v[m] = u,
                        u + a > A + w && (A = u,
                        w = a),
                        !E && Math.abs(m - C) <= l - 1 && u >= y[m])
                            return i[0] = u,
                            o[0] = a,
                            p <= y[m] && l <= 1448 ? this.WALKTRACE(b, c, h, S, C, f, d, L, v, y, u, t, i, a, r, o, E, s) : null
                    }
                    var M = (A - e + (w - n) - l) / 2;
                    if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(A, this.OriginalSequence, M))
                        ...
                        i[0] = A,
                        o[0] = w,
                        M > 0 && l <= 1448 ? this.WALKTRACE(b, c, h, S, C, f, d, L, v, y, u, t, i, a, r, o, E, s) : [new N(++e,t - e + 1,++n,r - n + 1)];
                    for (f = this.ClipDiagonalBound(C - l, l, C, g),
                    d = this.ClipDiagonalBound(C + l, l, C, g),
                    m = f; m <= d; m += 2) {
                        for (a = (u = m === f || m < d && y[m - 1] >= y[m + 1] ? y[m + 1] - 1 : y[m - 1]) - (m - C) - L,
                        p = u; u > e && a > n && this.ElementsAreEqual(u, a); )
                            u--,
                            a--;
                        if (y[m] = u,
                        E && Math.abs(m - b) <= l && u <= v[m])
                            return i[0] = u,
                            o[0] = a,
                            p >= v[m] && l <= 1448 ? this.WALKTRACE(b, c, h, S, C, f, d, L, v, y, u, t, i, a, r, o, E, s) : null
                    }
                    if (l <= 1447) {
                        var x = new Array(h - c + 2);
                        x[0] = b - c + 1,
                        P.Copy(v, c, x, 1, h - c + 1),
                        this.m_forwardHistory.push(x),
                        (x = new Array(d - f + 2))[0] = C - f + 1,
                        P.Copy(y, f, x, 1, d - f + 1),
            ...
            e.prototype.ShiftChanges = function(e) {
                ...
                do {
                    ...
                    for (n = 0; n < e.length; n++)
                        n < e.length - 1 && this.ChangesOverlap(e[n], e[n + 1], l) ? (t = !0,
                        a.push(l[0]),
                        n++) : a.push(e[n]);
                    e = a
                    ...
                    if (n > 0) {
                        var c = e[n - 1];
                        c.originalLength > 0 && (i = c.originalStart + c.originalLength),
                        c.modifiedLength > 0 && (o = c.modifiedStart + c.modifiedLength)
                    }
                    s = r.originalLength > 0,
                    u = r.modifiedLength > 0;
                    for (var h = 0, f = this._boundaryScore(r.originalStart, r.originalLength, r.modifiedStart, r.modifiedLength), d = 1; ; d++) {
                        var m = r.originalStart - d
                          , p = r.modifiedStart - d;
                        if (m < i || p < o)
                            break;
                        if (s && !this.OriginalElementsAreEqual(m, m + r.originalLength))
                            break;
                        if (u && !this.ModifiedElementsAreEqual(p, p + r.modifiedLength))
                            break;
                        var _ = this._boundaryScore(m, r.originalLength, p, r.modifiedLength);
                        _ > f && (f = _,
                        h = d)
                    }
                    r.originalStart -= h,
            ...
            e.prototype.ConcatenateChanges = function(e, t) {
                var n = []
                  , r = null;
                return 0 === e.length || 0 === t.length ? t.length > 0 ? t : e : this.ChangesOverlap(e[e.length - 1], t[0], n) ? (r = new Array(e.length + t.length - 1),
                P.Copy(e, 0, r, 0, e.length - 1),
                r[e.length - 1] = n[0],
                P.Copy(t, 1, r, e.length, t.length - 1),
                r) : (r = new Array(e.length + t.length),
            ...
            e.prototype.ChangesOverlap = function(e, t, n) {
                if (w.Assert(e.originalStart <= t.originalStart, "Left change is not less than or equal to right change"),
                w.Assert(e.modifiedStart <= t.modifiedStart, "Left change is not less than or equal to right change"),
        ...
        var O = 5e3
          , k = 3;
        function T(e, t, n, r) {
            return new x(e,t,n).ComputeDiff(r)
        }
        var I = function() {
            function e(t) {
          ...
          , U = function() {
            ...
            return e.createFromDiffChange = function(t, n, r) {
                ...
                0 === t.modifiedLength ? (a = 0,
                l = 0,
                c = 0,
                h = 0) : (a = r.getStartLineNumber(t.modifiedStart),
        ...
        var R = function() {
            ...
            return e.createFromDiffResult = function(t, n, r, i, o, s, u) {
                var a, l, c, h, f;
                if (0 === n.originalLength ? (a = r.getStartLineNumber(n.originalStart) - 1,
                l = 0) : (a = r.getStartLineNumber(n.originalStart),
                l = r.getEndLineNumber(n.originalStart + n.originalLength - 1)),
                0 === n.modifiedLength ? (c = i.getStartLineNumber(n.modifiedStart) - 1,
                h = 0) : (c = i.getStartLineNumber(n.modifiedStart),
                h = i.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)),
                s && 0 !== n.originalLength && 0 !== n.modifiedLength && o()) {
                    ...
                    u && (p = function(e) {
                        ...
                        for (var t = [e[0]], n = t[0], r = 1, i = e.length; r < i; r++) {
                            ...
                            Math.min(s, u) < k ? (n.originalLength = o.originalStart + o.originalLength - n.originalStart,
                            n.modifiedLength = o.modifiedStart + o.modifiedLength - n.modifiedStart) : (t.push(o),
                            n = o)
                        }
                        return t
                    }(p)),
                    f = [];
                    for (var _ = 0, g = p.length; _ < g; _++)
          ...
          , K = function() {
            function e(e, t, n) {
                ...
                this.original = new I(e),
                this.modified = new I(t)
            }
            return e.prototype.computeDiff = function() {
                ...
                var e = T(this.original, this.modified, this._continueProcessingPredicate.bind(this), this.shouldMakePrettyDiff);
                ...
                e.length); n < u; n++) {
                    for (var a = n + 1 < u ? e[n + 1] : null, l = a ? a.originalStart : this.originalLines.length, c = a ? a.modifiedStart : this.modifiedLines.length; o < l && s < c; ) {
                        ...
                        if (h !== f) {
                            ...
                            for (var p = I._getLastNonBlankColumn(h, 1), _ = I._getLastNonBlankColumn(f, 1), g = h.length + 1, v = f.length + 1; p < g && _ < v; ) {
                                if (h.charCodeAt(p - 1) !== h.charCodeAt(_ - 1))
                                    break;
                                p++,
                                _++
                            }
                    ...
                    a && (i.push(R.createFromDiffResult(this.shouldIgnoreTrimWhitespace, a, this.original, this.modified, this._continueProcessingPredicate.bind(this), this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)),
                    o += a.originalLength,
                    s += a.modifiedLength)
                }
                return i
            ...
            e.prototype._pushTrimWhitespaceCharChange = function(e, t, n, r, i, o, s) {
                var u;
                this._mergeTrimWhitespaceCharChange(e, t, n, r, i, o, s) || (this.shouldComputeCharChanges && (u = [new U(t,n,t,r,i,o,i,s)]),
                e.push(new R(t,t,i,i,u)))
            }
            ,
            e.prototype._mergeTrimWhitespaceCharChange = function(e, t, n, r, i, o, s) {
                ...
                if (0 === u)
                    return !1;
                var a = e[u - 1];
                return 0 !== a.originalEndLineNumber && 0 !== a.modifiedEndLineNumber && (a.originalEndLineNumber + 1 === t && a.modifiedEndLineNumber + 1 === i && (a.originalEndLineNumber = t,
                a.modifiedEndLineNumber = i,
                this.shouldComputeCharChanges && a.charChanges.push(new U(t,n,t,r,i,o,i,s)),
                !0))
            }
            ,
        ...
        var W = function(e, t) {
          ...
          , j = function() {
            ...
            e.prototype.getIndexOf = function(e) {
                e = Math.floor(e),
                this.getTotalValue();
                for (var t, n, r, i = 0, o = this.values.length - 1; i <= o; )
                    if (t = i + (o - i) / 2 | 0,
                    e < (r = (n = this.prefixSum[t]) - this.values[t]))
                        o = t - 1;
                    else {
                        if (!(e >= n))
                            break;
          ...
          , Y = (function() {
            ...
            e.prototype.warmUpCache = function(e, t) {
                ...
                this._cache = n,
                this._cacheAccumulatedValueStart = e
            }
        }(),
        function() {
            function e(e, t, n, r) {
            ...
            e.prototype.onEvents = function(e) {
                ...
                for (var t = e.changes, n = 0, r = t.length; n < r; n++) {
                    ...
                    this._acceptInsertText(new S(i.range.startLineNumber,i.range.startColumn), i.text)
                }
        ...
        var Q = function() {
            ...
            e.computeLinks = function(t) {
                for (var n = (null === J && (J = new H([[1, 104, 2], [1, 72, 2], [1, 102, 6], [1, 70, 6], [2, 116, 3], [2, 84, 3], [3, 116, 4], [3, 84, 4], [4, 112, 5], [4, 80, 5], [5, 115, 9], [5, 83, 9], [5, 58, 10], [6, 105, 7], [6, 73, 7], [7, 108, 8], [7, 76, 8], [8, 101, 9], [8, 69, 9], [9, 58, 10], [10, 47, 11], [11, 47, 12]])),
                J), r = function() {
                    if (null === z) {
                        z = new B(0);
                    ...
                    for (var u = t.getLineContent(o), a = u.length, l = 0, c = 0, h = 0, f = 1, d = !1, m = !1, p = !1; l < a; ) {
                        ...
                        if (13 === f) {
                            ...
                            1 === v && (i.push(e._createLink(r, u, o, c, l)),
                            _ = !0)
                        } else if (12 === f) {
                            1 === (v = r.get(g)) ? _ = !0 : f = 13
                        } else
                            0 === (f = n.nextState(f, g)) && (_ = !0);
                        _ && (f = 1,
                        d = !1,
                        m = !1,
                        p = !1,
        ...
        var G = function() {
            ...
            e.prototype.valueSetReplace = function(e, t, n) {
                var r = e.indexOf(t);
                return r >= 0 ? ((r += n ? 1 : -1) < 0 ? r = e.length - 1 : r %= e.length,
                e[r]) : null
            }
            ,
            e.INSTANCE = new e,
        ...
        var $ = function(e) {
            void 0 === e && (e = "");
            for (var t = "(-?\\d*\\.\\d\\w*)|([^", n = 0; n < X.length; n++)
                e.indexOf(X[n]) >= 0 || (t += "\\" + X[n]);
            return t += "\\s]+)",
            new RegExp(t,"g")
        }();
        var Z = {};
        C.a.addEventListener("error", function(e) {
            var t = e.detail
              , n = t.id;
            t.parent ? t.handler && Z && delete Z[n] : (Z[n] = t,
            1 === Object.keys(Z).length && setTimeout(function() {
                var e = Z;
                Z = {},
                Object.keys(e).forEach(function(t) {
                    var n = e[t];
                    n.exception ? te(n.exception) : n.error && te(n.error),
                    ...
                    for (var e = n._first; e instanceof le; e = e.next)
                        if (e === r) {
                            if (e.prev && e.next) {
                                ...
                                e.prev || e.next ? e.next ? e.prev || (n._first = n._first.next,
                                n._first.prev = void 0) : (n._last = n._last.prev,
                                n._last.next = void 0) : (n._first = void 0,
                                n._last = void 0);
                            break
                        }
                }
            ...
            return Object.defineProperty(e.prototype, "event", {
                get: function() {
                    ...
                    return this._event || (this._event = function(n, r, i) {
                        ...
                        var s, u = t._listeners.push(r ? [n, r] : n);
                        return o && t._options && t._options.onFirstListenerDidAdd && t._options.onFirstListenerDidAdd(t),
        ...
        var ye, be, Ce = function(e) {
            function t(t, n, r, i) {
                var o = e.call(this, t, n, r, i) || this;
                return o.selectionStartLineNumber = t,
            ...
            ,
            t
        }(L), Se = Object.freeze(function(e, t) {
        ...
        (be = ye || (ye = {})).None = Object.freeze({
            isCancellationRequested: !1,
            onCancellationRequested: ue.None
        }),
        be.Cancelled = Object.freeze({
            isCancellationRequested: !0,
            onCancellationRequested: Se
        });
        var Le, Ne, Ee = function() {
            function e() {
                this._isCancelled = !1
            }
            ...
            Object.defineProperty(e.prototype, "onCancellationRequested", {
                get: function() {
                    return this._isCancelled ? Se : (this._emitter || (this._emitter = new he),
                    this._emitter.event)
                },
                enumerable: !0,
                configurable: !0
            ...
            return Object.defineProperty(e.prototype, "token", {
                get: function() {
                    return this._token || (this._token = new Ee),
                    this._token
                },
                enumerable: !0,
                configurable: !0
        ...
        var xe = function() {
            ...
            t.prototype.getWordAtPosition = function(e, t) {
                var n = function(e, t, n, r) {
                    ...
                    var o = i[0].indexOf(" ") >= 0 ? function(e, t, n, r) {
                        ...
                        var i, o = e - 1 - r, s = n.lastIndexOf(" ", o - 1) + 1, u = n.indexOf(" ", o);
                        for (-1 === u && (u = n.length),
                        t.lastIndex = s; i = t.exec(n); )
                            if (i.index <= o && t.lastIndex >= o)
                                return {
                                    word: i[0],
                                    startColumn: r + 1 + i.index,
                                    endColumn: r + 1 + t.lastIndex
                ...
                return n ? new L(e.lineNumber,n.startColumn,e.lineNumber,n.endColumn) : null
            }
            ,
          ...
          , ke = function(e) {
            function t(t) {
                ...
                return n._models = Object.create(null),
                n
            }
            return xe(t, e),
            ...
            t.prototype.acceptNewModel = function(e) {
                this._models[e.url] = new Oe(m.parse(e.url),e.lines,e.EOL,e.versionId)
            }
            ,
            ...
            e.prototype.computeMoreMinimalEdits = function(t, n) {
                ...
                if (!r)
                    return C.a.as(n);
                for (var i, o = [], s = 0, u = n; s < u.length; s++) {
                    var a = u[s]
                      , l = a.range
                      , c = a.text
                      , h = a.eol;
                    if ("number" == typeof h && (i = h),
                    l) {
                        ...
                        if (f !== (c = c.replace(/\r\n|\n|\r/g, r.eol)))
                            if (Math.max(c.length, f.length) > e._diffLimit)
                                ...
                                for (var d = A(f, c, !1), m = r.offsetAt(L.lift(l).getStartPosition()), p = 0, _ = d; p < _.length; p++) {
                                    var g = _[p]
                                    ...
                                    r.getValueInRange(b.range) !== b.text && o.push(b)
                                }
                    }
                }
                return "number" == typeof i && o.push({
                    eol: i,
                    text: void 0,
                    range: void 0
                }),
            ...
            e.prototype.textualSuggest = function(t, n, r, i) {
                ...
                if (o) {
                    ...
                    l[a] = !0;
                    for (var c = o.createWordIterator(u), h = c.next(); !h.done && s.length <= e._suggestionsLimit; h = c.next()) {
                        var f = h.value;
                        l[f] || (l[f] = !0,
                        isNaN(Number(f)) && s.push({
                            type: "text",
                            label: f,
                            insertText: f,
                            noAutoAccept: !0,
            ...
            e.prototype.navigateValueSet = function(e, t, n, r, i) {
                ...
                var u = o.getValueInRange(t)
                  ...
                  , l = null;
                null !== a && (l = o.getValueInRange(a));
                var c = G.INSTANCE.navigateValueSet(t, u, a, l, n);
                return C.a.as(c)
            }
            ,
            e.prototype.loadForeignModule = function(e, t) {
                ...
                if (this._foreignModuleFactory) {
                    ...
                    var i = [];
                    for (var o in this._foreignModule)
            ...
            e.prototype.fmr = function(e, t) {
                if (!this._foreignModule || "function" != typeof this._foreignModule[e])
                    return C.a.wrapError(new Error("Missing requestHandler or method: " + e));
                try {
        ...
        "function" == typeof importScripts && (o.a.monaco = {
            editor: void 0,
            languages: void 0,
            CancellationTokenSource: Ae,
            Emitter: he,
            KeyCode: Pe,
            KeyMod: Me,
            Position: S,
        ...
        (function() {
            ...
            e.prototype.queue = function(e) {
                ...
                if (this.activePromise) {
                    if (this.queuedPromiseFactory = e,
                    !this.queuedPromise) {
                        var n = function() {
                            t.queuedPromise = null;
                            var e = t.queue(t.queuedPromiseFactory);
                            return t.queuedPromiseFactory = null,
                            e
                        };
                ...
                return this.activePromise = e(),
                new C.a(function(e, n, r) {
        ...
        function() {
            ...
            e.prototype.trigger = function(e, t) {
                ...
                this.task = e,
                this.cancelTimeout(),
                this.completionPromise || (this.completionPromise = new C.a(function(e) {
                    n.onSuccess = e
                }
                ,function() {}
                ).then(function() {
            ...
            e.prototype.cancel = function() {
                this.cancelTimeout(),
                this.completionPromise && (this.completionPromise.cancel(),
                this.completionPromise = null)
            }
            ,
        ...
        (function(e) {
            ...
            t.prototype.cancel = function() {
                -1 !== this._token && (clearTimeout(this._token),
                this._token = -1)
            }
            ,
        ...
        function(e) {
            ...
            ,
            t.prototype.cancel = function() {
                -1 !== this._token && (clearInterval(this._token),
                this._token = -1)
            }
            ,
            t.prototype.cancelAndSet = function(e, t) {
        ...
        function() {
            ...
            ,
            e.prototype.cancel = function() {
                this.isScheduled() && (clearTimeout(this.timeoutToken),
                this.timeoutToken = -1)
            }
            ,
        ...
        var Re = function() {
            ...
            e.prototype.sendMessage = function(e, t) {
                ...
                return this._pendingReplies[n] = r,
                this._send({
            ...
            e.prototype._handleMessage = function(e) {
                ...
                if (e.seq) {
                    ...
                    if (delete this._pendingReplies[n.seq],
                    n.err) {
                        var i = n.err;
                        return n.err.$isError && ((i = new Error).name = n.err.name,
                    ...
                    this._handler.handleMessage(o.method, o.args).then(function(e) {
                        ...
                        e.detail instanceof Error && (e.detail = ne(e.detail)),
                        t._send({
                            vsWorker: t._workerId,
                            seq: s,
                            res: void 0,
          ...
          , Ke = (function(e) {
            function t(t, n) {
                ...
                var s = null;
                void 0 !== self.require && "function" == typeof self.require.getConfig ? s = self.require.getConfig() : void 0 !== self.requirejs && (s = self.requirejs.s.contexts._.config),
                r._lazyProxy = new C.a(function(e, t) {
                    i = e,
                    o = t
                }
                ,function() {}
                ),
                r._onModuleLoaded = r._protocol.sendMessage(Ue, [r._worker.getId(), n, s]),
                r._onModuleLoaded.then(function(e) {
                    for (var t = {}, n = 0; n < e.length; n++)
                        t[e[n]] = a(e[n], u);
                    i(t)
                }, function(e) {
                    o(e),
                    r._onError("Worker failed to load " + n, e)
                });
                var u = function(e, t) {
        ...
        function() {
            ...
            e.prototype.initialize = function(e, t, n) {
                var r, i, o = this;
                if (this._protocol.setWorkerId(e),
                this._requestHandler) {
                    var s = [];
                    for (var u in this._requestHandler)
                        "function" == typeof this._requestHandler[u] && s.push(u);
                    return C.a.as(s)
                }
                n && (void 0 !== n.baseUrl && delete n.baseUrl,
                void 0 !== n.paths && void 0 !== n.paths.vs && delete n.paths.vs,
                n.catchError = !0,
                self.require.config(n));
                var a = new C.a(function(e, t) {
                    r = e,
                    i = t
                }
                );
                return self.require([t], function() {
                    ...
                    var i = [];
                    for (var s in o._requestHandler)
    ...
    MNsG: function(e, t, n) {
        ...
        (function(e, r) {
            ...
            if ("object" == typeof e && "function" == typeof e.nextTick && "string" == typeof e.platform) {
                ...
                if (c)
                    try {
                        ...
                        h.locale,
                        f || "en",
                        h._translationsConfigFile
                    } catch (e) {}
                a = !0
            } else if ("object" == typeof navigator) {
                var d = navigator.userAgent;
                o = d.indexOf("Windows") >= 0,
                s = d.indexOf("Macintosh") >= 0,
                u = d.indexOf("Linux") >= 0,
                l = !0,
                navigator.language
            }
            ...
            i.Web;
            a && (s ? i.Mac : o ? i.Windows : u && i.Linux);
            var m = o
              , p = l
              , _ = "object" == typeof self ? self : "object" == typeof r ? r : {}
        }
            ...
            function() {
                ...
                n("WinJS/Core/_BaseCoreUtils", ["WinJS/Core/_Global"], function(e) {
                    ...
                    return {
                        ...
                        markSupportedForProcessing: function(e) {
                            return e.supportedForProcessing = !0,
                            e
                        },
                        _setImmediate: function(t) {
                            null === n && (n = e.setImmediate ? e.setImmediate.bind(e) : void 0 !== r && "function" == typeof r.nextTick ? r.nextTick.bind(r) : e.setTimeout.bind(e)),
                            n(t)
                        }
                    }
                }),
                        ...
                        e.Namespace.define("WinJS.Class", {
                            ...
                            derive: function(e, r, o, s) {
                                if (e) {
                                    ...
                                    ;
                                    var u = e.prototype;
                                    return r.prototype = Object.create(u),
                    ...
                    function n(e) {
                        ...
                        return {
                            ...
                            set: function(n) {
                                ...
                                r.userHandler = n) : r && (this.removeEventListener(e, r.wrapper, !1),
                                this[t] = null)
                            },
                            enumerable: !0
                        }
                            ...
                            if (r)
                                for (var i = 0, o = r.length; i < o; i++) {
                                    ...
                                    if (s.listener === t && s.useCapture === n) {
                                        r.splice(i, 1),
                                        0 === r.length && delete this._listeners[e];
                                        break
                                    }
                                }
                        }
                ...
                n("WinJS/Promise/_StateMachine", ["WinJS/Core/_Global", "WinJS/Core/_BaseCoreUtils", "WinJS/Core/_Base", "WinJS/Core/_ErrorFromName", "WinJS/Core/_Events", "WinJS/Core/_Trace"], function(e, t, n, r, i, o) {
                    ...
                    d = {
                        ...
                        enter: function(e) {
                            var t = e._value;
                            if (t instanceof W && t._state !== b && t._state !== v)
                                U(t, {
                                    promise: e
                                });
                            else {
                                var n = function(r) {
                                    t._errorId ? e._chainedError(r, t) : (I(e, r, A, t, n),
                                    e._error(r))
                                };
                                n.handlesOnError = !0,
                    ...
                    var L = n.Class.define(null, {
                        ...
                        then: function e(t, n, r) {
                            if (this.then === e)
                                return this._state.then(this, t, n, r);
                            this.then(t, n, r)
                        },
                        _chainedError: function(e, t) {
                            var n = this._state._error(this, e, w, t);
                            return this._run(),
                            n
                        },
                        ...
                        _error: function(e) {
                            var t = this._state._error(this, e, P);
                            return this._run(),
                            t
                        },
                        ...
                        _setChainedErrorValue: function(e, t) {
                            var n = this._state._setErrorValue(this, e, w, t);
                            return this._run(),
                            n
                        },
                        _setExceptionValue: function(e) {
                            var t = this._state._setErrorValue(this, e, M);
                            return this._run(),
                            t
                        },
                        _run: function() {
                    ...
                    function N(e, t) {
                        var n;
                        n = t && "object" == typeof t && "function" == typeof t.then ? d : g,
                        e._value = t,
                        e._setState(n)
                    }
                    ...
                    function A(e, t, n, r) {
                        ...
                        return E(i ? t : null, i ? null : t, e, n._errorId, n, r)
                    }
                    function w(e, t, n) {
                        var r = n._isException
                          , i = n._errorId;
                        return R(e, i, r),
                        E(r ? t : null, r ? null : t, e, i, n)
                    }
                    function P(e, t) {
                        var n = ++C;
                        return R(e, n),
                    ...
                    function k(t, n) {
                        var r, i, s = t._value, u = t._listeners;
                        if (u)
                            for (t._listeners = null,
                            r = 0,
                            i = Array.isArray(u) ? u.length : 1; r < i; r++) {
                                var a = 1 === i ? u : u[r]
                                  , l = a.c
                                  , c = a.promise;
                                if (o._traceAsyncOperationCompleted(a.asyncOpID, e.Debug && e.Debug.MS_ASYNC_OP_STATUS_SUCCESS),
                                c) {
                        ...
                        if (u)
                            ...
                            i = Array.isArray(u) ? u.length : 1; r < i; r++) {
                                var l = 1 === i ? u : u[r]
                                  , c = l.e
                                  , h = l.promise
                                  , f = e.Debug && (s && s.name === a ? e.Debug.MS_ASYNC_OP_STATUS_CANCELED : e.Debug.MS_ASYNC_OP_STATUS_ERROR);
                                if (o._traceAsyncOperationCompleted(l.asyncOpID, f),
                                h) {
                                    var m = !1;
                                    try {
                                        c ? (o._traceAsyncCallbackStarting(l.asyncOpID),
                                        m = !0,
                                        c.handlesOnError || I(h, s, A, t, c),
                                        h._setCompleteValue(c(s))) : h._setChainedErrorValue(s, t)
                                    } catch (e) {
                                    ...
                                    j.prototype.done.call(t, null, c)
                            }
                    }
                    function I(e, t, n, r, i) {
                        if (s._listeners[u]) {
                            if (t instanceof Error && t.message === a)
                                return;
                            s.dispatchEvent(u, n(e, t, r, i))
                        }
                    }
                    function D(e, t) {
                        ...
                        if (i)
                            for (n = 0,
                            r = Array.isArray(i) ? i.length : 1; n < r; n++) {
                                var o = 1 === r ? i : i[n]
                                  , s = o.p;
                                if (s)
                                    try {
                    ...
                    function q(e, t) {
                        var n;
                        n = t && "object" == typeof t && "function" == typeof t.then ? d : v,
                        e._value = t,
                        e._setState(n)
                    }
                    function V(e, t, n, r) {
                    ...
                    var F, W = n.Class.derive(L, function(e) {
                        l && (!0 === l || l & c.thenPromise) && (this._stack = H._getStack()),
                        this._creator = e,
                        this._setState(h),
                        this._run()
                    }, {
                        ...
                        l && (!0 === l || l & c.errorPromise) && (this._stack = H._getStack()),
                        this._value = e,
                        I(this, e, P)
                    }, {
                        cancel: function() {},
                            ...
                            if (t)
                                try {
                                    t.handlesOnError || I(null, n, A, this, t);
                                    var r = t(n);
                        ...
                        then: function(e, t) {
                            ...
                            var n, r = this._value;
                            try {
                                t.handlesOnError || I(null, r, A, this, t),
                                n = new B(t(r))
                            } catch (e) {
                                n = e === r ? this : new Y(e)
                            }
                        ...
                        supportedForProcessing: !1
                    }), Y = n.Class.derive(j, function(e) {
                        l && (!0 === l || l & c.exceptionPromise) && (this._stack = H._getStack()),
                        this._value = e,
                        I(this, e, M)
                    }, {}, {
                        supportedForProcessing: !1
                    }), B = n.Class.define(function(e) {
                        if (l && (!0 === l || l & c.completePromise) && (this._stack = H._getStack()),
                        e && "object" == typeof e && "function" == typeof e.then) {
                            var t = new W(null);
                            return t._setCompleteValue(e),
                            t
                        }
                        this._value = e
                    }, {
                    ...
                    var H = n.Class.derive(L, function(e, t) {
                        l && (!0 === l || l & c.promise) && (this._stack = H._getStack()),
                        this._oncancel = t,
                        this._setState(h),
                        this._run();
                        try {
                    ...
                    return Object.defineProperties(H, i.createEventProperties(u)),
                ...
                (i = t["WinJS/Core/_WinJS"]).TPromise = i.Promise,
                i.PPromise = i.Promise
            }();
            i.Promise;
            var o = i.TPromise;
            i.PPromise
...
//# sourceMappingURL=https://staging.hackerrank.net/fcore-assets/sourcemaps/editor.worker.js.map
